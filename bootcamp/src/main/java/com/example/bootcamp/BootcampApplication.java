...
public class BootcampApplication {
	...
	public void mockUser() {
		...
		Address address = new Address(1, "johnj345@test.com", "123/4 ซอยจุ๊", "10234", "พระราม 10", "กรุงเทพ", "0987654321", true, 20001);
		...
		Product product2 = new Product(10002, "Adidas NMD R1 Color Core Black", 12000, 33, "Comfort");
		Product product3 = new Product(10003, "SHOE NMD Sneakers Fashion", 1900, 79, "Comfort");
		productRepository.save(product1);
		productRepository.save(product2);
		productRepository.save(product3);

		productImageRepository.save(new ProductImage(1, "http://image.com/1", 10001));
		productImageRepository.save(new ProductImage(2, "http://image.com/2", 10001));
		productImageRepository.save(new ProductImage(3, "http://image.com/3", 10001));
